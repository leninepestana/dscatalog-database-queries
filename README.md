...
# 🙌  Back end features for our implementation project 🙌

https://github.com/devsuperior/dscatalog-resources/tree/master/backend

## Maven dependencies

### Get the full pom.xml for Spring Boot version 2.4.2 from the link below:
...
## JSON objects to insert and update a product
...
## Seed for users and their profiles
...
## Interim configuration to release all endpoints
...
## Steps to change master to main on Github
...
<ul>
    <li>In the project root folder, create system.properties file with the content: java.runtime.version=11</li>
    <li>Change profile to "prod" and save a new commit</li>
</ul>

#### Deploy the system on Heroku

<ul>
    <li>Create app on Heroku and provision Postgresql database</li>
    <li>Get the database connection string</li>
    <li>Instantiate a server in your pgAdmin with connection data</li>
    <li>Run the database creation script</li>
    <li>At the terminal:</li>
</ul>
...
<ul>
    ...
    <li>client-id: dscatalog</li>
    <li>client-secret: dscatalog123</li>
    <li>username: leia@gmail.com</li>
    <li>password: 123456</li>
    <li>token:</li>
</ul>

<p>Script para atribuir token à variável de ambiente do Postman:</p>
...
## Releasing Public Read on S3 Bucket
